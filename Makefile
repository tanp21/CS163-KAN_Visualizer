...
# INCLUDE_PATHS = -I. -I$(RAYLIB_PATH)/src -I$(RAYLIB_PATH)/src/external -IKAN
...
# OBJS ?= main.cpp ./KAN.cpp ./KANLayer.cpp ./spline.cpp ./utils.cpp
...
# Compiler flags
CXXFLAGS = -std=c++20 -Wno-enum-compare

# Include directories
INCLUDES = -Iinclude

# Library directories and linked libraries
LDFLAGS = -Llib -lraylib -lwinmm -lgdi32
...
$(TARGET): $(OBJS)
	$(CXX) $(OBJS) -o $(TARGET) $(CXXFLAGS) $(INCLUDES) $(LDFLAGS)
